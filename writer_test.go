...
func TestAddSegmentToMediaPlaylist(t *testing.T) {
	...
	e = p.Append("test01.ts", 10.0, "title", false)
	if e != nil {
...
func TestDiscontinuityForMediaPlaylist(t *testing.T) {
	...
	p.Close()
	if e = p.Append("test01.ts", 5.0, "", false); e != nil {
		t.Errorf("Add 1st segment to a media playlist failed: %s", e)
	}
	if e = p.Append("test02.ts", 6.0, "", false); e != nil {
		t.Errorf("Add 2nd segment to a media playlist failed: %s", e)
	}
	if e = p.SetDiscontinuity(); e != nil {
		t.Error("Can't set discontinuity tag")
	}
	if e = p.Append("test03.ts", 6.0, "", false); e != nil {
...
func TestTargetDurationForMediaPlaylist(t *testing.T) {
	...
	e = p.Append("test01.ts", 9.0, "", false)
	if e != nil {
		t.Errorf("Add 1st segment to a media playlist failed: %s", e)
	}
	e = p.Append("test02.ts", 9.1, "", false)
	if e != nil {
		t.Errorf("Add 2nd segment to a media playlist failed: %s", e)
	}
...
func TestOverAddSegmentsToMediaPlaylist(t *testing.T) {
	...
	for i := 0; i < 11; i++ {
		e = p.Append(fmt.Sprintf("test%d.ts", i), 5.0, "", false)
		if e != nil {
...
func TestSetSCTE35(t *testing.T) {
	...
	_ = p.Append("test01.ts", 10.0, "title", false)
	if err := p.SetSCTE35(scte); err != nil {
...
func TestSetMapForMediaPlaylist(t *testing.T) {
	...
	e = p.Append("test01.ts", 5.0, "", false)
	if e != nil {
		t.Errorf("Add 1st segment to a media playlist failed: %s", e)
	}
...
func TestEncryptionKeyMethodNoneInMediaPlaylist(t *testing.T) {
	...
	p.Append("segment-1.ts", 4, "", false)
	p.SetKey("AES-128", "key-uri", "iv", "identity", "1")
	p.Append("segment-2.ts", 4, "", false)
	p.SetKey("NONE", "", "", "", "")
...
func TestMediaPlaylistWithIntegerDurations(t *testing.T) {
	...
	for i := 0; i < 9; i++ {
		e = p.Append(fmt.Sprintf("test%d.ts", i), 5.6, "", false)
		if e != nil {
			t.Errorf("Add segment #%d to a media playlist failed: %s", i, e)
		}
	}
...
func TestMediaPlaylistWinsize(t *testing.T) {
	...
	for i := 1; i < 10; i++ {
		p.Slide(fmt.Sprintf("test%d.ts", i), 5.6, "", false)
...
func TestMediaPlaylist_Slide(t *testing.T) {
	...
	_ = m.Append("t00.ts", 10, "", false)
	_ = m.Append("t01.ts", 10, "", false)
	_ = m.Append("t02.ts", 10, "", false)
	_ = m.Append("t03.ts", 10, "", false)
	if m.Count() != 4 {
	...
	m.Slide("t05.ts", 10, "", false)
	m.Slide("t06.ts", 10, "", false)
	if m.Count() != 4 {
		t.Fatalf("Excepted segments in media playlist: 4, got: %v", m.Count())
	}
	if m.SeqNo != 3 {
...
func ExampleMediaPlaylist_String() {
	p, _ := NewMediaPlaylist(1, 2)
	p.Append("test01.ts", 5.0, "", false)
	p.Append("test02.ts", 6.0, "", false)
	fmt.Printf("%s\n", p)
	// Output:
	// #EXTM3U
	// #EXT-X-VERSION:3
...
func ExampleMasterPlaylist_String() {
	...
	for i := 0; i < 5; i++ {
		p.Append(fmt.Sprintf("test%d.ts", i), 5.0, "", false)
	}
